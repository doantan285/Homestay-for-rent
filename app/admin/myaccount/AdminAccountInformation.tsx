...
11
const AdminAccountInformation: React.FC<AdminAccountInformationProps> = ({
    title,
    content,
    actionLabel,
    updateField,
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (updateField === "name") {
                apiUrl = "/api/admin/account/name";
                data = { name: newContent };
            } else if (updateField === "phoneNumber") {
                apiUrl = "/api/admin/account/phone";
                ...
                apiUrl = "/api/admin/account/change-password";
                data = {
                    currentPassword,
                    newPassword,
                    confirmNewPassword
