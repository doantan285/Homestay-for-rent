...
const LocationSelect: React.FC<LocationSelectProps> = ({
    ...
    const [selectedProvince, setSelectedProvince] = useState<LocationSelectValue['province'] | null>(null);
    const [selectedDistrict, setSelectedDistrict] = useState<LocationSelectValue['district'] | null>(null);
